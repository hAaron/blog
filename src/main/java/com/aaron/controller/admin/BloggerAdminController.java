...
public class BloggerAdminController {
	...
	public String save(@RequestParam("imageFile") MultipartFile imageFile,Blogger blogger,HttpServletRequest request,HttpServletResponse response)throws Exception{
		if(!imageFile.isEmpty()){
			...
			imageFile.transferTo(new File(FileConstants.fileuploadPath+File.separator+imageName));
	...
	public String modifyPassword(String newPassword,HttpServletResponse response)throws Exception{
		...
		blogger.setPassword(CryptographyUtil.md5(newPassword, Constants.PASSOWORD_MD5));
		int resultTotal=bloggerService.update(blogger);
